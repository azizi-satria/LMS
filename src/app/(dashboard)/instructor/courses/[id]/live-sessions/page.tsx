    ...
    <div style={{ padding: "32px 24px", maxWidth: 800 }}>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: 60, background: "var(--card-bg)", border: "1px solid var(--border-color)", borderRadius: 12 }}>
          ...
          <p style={{ color: "var(--text-secondary)", marginBottom: 16 }}>Belum ada sesi live. Tambahkan jadwal Zoom pertama.</p>
          <button onClick={() => setShowModal(true)} style={{ background: "var(--accent-primary)", color: "#fff", border: "none", borderRadius: 10, padding: "10px 24px", fontWeight: 600, cursor: "pointer" }}>+ Tambah Sesi</button>
        </div>
      ) : (
